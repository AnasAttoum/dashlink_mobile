...
export default function TableOffersMUI() {
  ...
  return (
    <>
        ...
        <Paper sx={{ width: '100%', mb: 2, borderRadius: '15px', boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px ' }}>
          ...
          {rows.length === 0 ?
            <div className='flex flex-col justify-center items-center gap-5' style={{ minHeight: '50vh' }}>
              <div className='p-3 text-center' style={{ color: 'var(--primary)' }}>No offer for this device yet</div>
      ...
      <Slider open={open} setOpen={setOpen} selected={selected} setSelected={setSelected} type='offer' />
    </>
  );
}
